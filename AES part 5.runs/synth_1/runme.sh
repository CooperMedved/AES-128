...
HD_PWD='C:/Users/User/AES part 5/AES part 5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_uart_aes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_uart_aes.tcl
