...
HD_PWD='C:/Users/User/AES part 5/AES part 5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_uart_aes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_uart_aes.tcl -notrace
