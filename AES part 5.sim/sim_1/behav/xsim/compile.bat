...
REM
REM Generated by Vivado on Fri Dec 05 11:37:25 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_aes128_ecb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_aes128_ecb_vlog.prj -log xvlog.log
